...
ActiveRecord::Schema[7.1].define(version: 2026_08_13_000000) do
  ...
  create_table "channel_email", force: :cascade do |t|
    ...
    t.text "imap_folders", default: [], array: true
  ...
  create_table "conversation_pins", force: :cascade do |t|
    ...
    t.index ["conversation_id"], name: "idx_conv_pins_unique", unique: true
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.index ["account_id", "archived_at"], name: "index_conversations_on_account_id_and_archived_at"
